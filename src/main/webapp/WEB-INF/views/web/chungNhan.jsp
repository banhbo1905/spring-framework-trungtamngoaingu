...
<!-- Overlay effect when opening sidebar on small screens -->
	...
	<div class="w3-main" style="margin-left: 280px">
		...
		<div class="w3-row w3-padding-64 center-table">
			...
			<h1 class="w3-text-teal">Nhập số báo danh và chọn khoá thi</h1>
			<form action="/chung-nhan-ket-qua" method="post">
				<ul class="wrapper">
					<li class="form-row"><label style="text-align: end;">Nhập
							số báo danh: </label><input type="text" name="sbd"></li>

					<li class="form-row"
						style="justify-content: center; margin-right: 63.5%;"><label style="flex-grow:1;">Chọn khóa thi:</label>&nbsp;&nbsp; <select
						name="khoathi">
